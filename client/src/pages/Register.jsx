...
import { Leaf, User, Mail, Lock, ArrowRight, Loader2, Trophy } from "lucide-react";
...
const Register = () => {
  ...
  const handleSignup = async (e) => {
    ...
    setSubmitting(true);
    try {
      const url = "https://ecolife-ai.onrender.com/api/auth/register"; 
    ...
    <div className="eco-auth">
      ...
      <div className="auth-card">
        <div className="auth-form-side">
          ...
          <p className="eyebrow">Join EcoLife AI</p>
        ...
        <div className="auth-side-panel">
          <span className="side-badge">
            <Trophy size={13} /> Already tracking?
          </span>
          <h2 className="display side-title">Welcome back</h2>
          <p className="side-copy">
            Log in to pick up your streak, check your green score, and keep
            your ring growing.
          </p>
